...
class AppFonts {
  ...
  TextStyle f13amberlight = TextStyle(
      color: appColors.primaryLight, fontSize: 13);
      TextStyle f13amber = TextStyle(
      color: appColors.primaryDark, fontSize: 13);
      TextStyle f13black =const TextStyle(
      color: Colors.black, fontSize: 13);
      TextStyle f13grey =const TextStyle(
      color: Colors.grey, fontSize: 13);
      TextStyle f14w500black =const TextStyle(
      color: Colors.black, fontSize: 14,fontWeight: FontWeight.w500);
       TextStyle f15black =const TextStyle(
